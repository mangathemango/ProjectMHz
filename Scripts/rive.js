// THIS WAS NOT WRITTEN BY TEAM MHZ BTW
                ...
                var Rive = (() => {
                    ...
                    return (
                        function (moduleArg = {}) {
                            ...
                            function ca() {
                                function b(m) { const l = d; c = a = 0; d = new Map; l.forEach(n => { try { n(m) } catch (k) { console.error(k) } }); this.hb(); e && e.Fb() } let a = 0, c = 0, d = new Map, e = null, g = null; this.requestAnimationFrame = function (m) { a || (a = requestAnimationFrame(b.bind(this))); const l = ++c; d.set(l, m); return l }; this.cancelAnimationFrame = function (m) { d.delete(m); a && 0 == d.size && (cancelAnimationFrame(a), a = 0) }; this.Db = function (m) {
                                    g && (document.body.remove(g), g = null); m || (g = document.createElement("div"), g.style.backgroundColor = "black", g.style.position =
                                        "fixed", g.style.right = 0, g.style.top = 0, g.style.color = "white", g.style.padding = "4px", g.innerHTML = "RIVE FPS", m = function (l) { g.innerHTML = "RIVE FPS " + l.toFixed(1) }, document.body.appendChild(g)); e = new function () { let l = 0, n = 0; this.Fb = function () { var k = performance.now(); n ? (++l, k -= n, 1E3 < k && (m(1E3 * l / k), l = n = 0)) : (n = k, l = 0) } }
                                }; this.Ab = function () { g && (document.body.remove(g), g = null); e = null }; this.hb = function () { }
                            }
                            ...
                            const ea = "createConicGradient createImageData createLinearGradient createPattern createRadialGradient getContextAttributes getImageData getLineDash getTransform isContextLost isPointInPath isPointInStroke measureText".split(" "), fa = new function () {
                                function b() {
                                    if (!a) {
                                        var f = document.createElement("canvas"), r = {
                                            alpha: 1, depth: 0, stencil: 0, antialias: 0, premultipliedAlpha: 1, preserveDrawingBuffer: 0, preferLowPowerToHighPerformance: 0, failIfMajorPerformanceCaveat: 0, enableExtensionsByDefault: 1, explicitSwapControl: 1,
                                            renderViaOffscreenBackBuffer: 1
                                        }; let q; if (/iPhone|iPad|iPod/i.test(navigator.userAgent)) { if (q = f.getContext("webgl", r), c = 1, !q) return console.log("No WebGL support. Image mesh will not be drawn."), !1 } else if (q = f.getContext("webgl2", r)) c = 2; else if (q = f.getContext("webgl", r)) c = 1; else return console.log("No WebGL support. Image mesh will not be drawn."), !1; q = new Proxy(q, {
                                            get(D, u) {
                                                if (D.isContextLost()) {
                                                    if (n || (console.error("Cannot render the mesh because the GL Context was lost. Tried to invoke ", u), n = !0),
                                                        "function" === typeof D[u]) return function () { }
                                                } else return "function" === typeof D[u] ? function (...I) { return D[u].apply(D, I) } : D[u]
                                            }, set(D, u, I) { if (D.isContextLost()) n || (console.error("Cannot render the mesh because the GL Context was lost. Tried to set property " + u), n = !0); else return D[u] = I, !0 }
                                        }); d = Math.min(q.getParameter(q.MAX_RENDERBUFFER_SIZE), q.getParameter(q.MAX_TEXTURE_SIZE)); function G(D, u, I) {
                                            u = q.createShader(u); q.shaderSource(u, I); q.compileShader(u); I = q.getShaderInfoLog(u); if (0 < (I || "").length) throw I;
                                            q.attachShader(D, u)
                                        } f = q.createProgram(); G(f, q.VERTEX_SHADER, "attribute vec2 vertex;\n                attribute vec2 uv;\n                uniform vec4 mat;\n                uniform vec2 translate;\n                varying vec2 st;\n                void main() {\n                    st = uv;\n                    gl_Position = vec4(mat2(mat) * vertex + translate, 0, 1);\n                }"); G(f, q.FRAGMENT_SHADER, "precision highp float;\n                uniform sampler2D image;\n                varying vec2 st;\n                void main() {\n                    gl_FragColor = texture2D(image, st);\n                }");
                                        q.bindAttribLocation(f, 0, "vertex"); q.bindAttribLocation(f, 1, "uv"); q.linkProgram(f); r = q.getProgramInfoLog(f); if (0 < (r || "").trim().length) throw r; e = q.getUniformLocation(f, "mat"); g = q.getUniformLocation(f, "translate"); q.useProgram(f); q.bindBuffer(q.ARRAY_BUFFER, q.createBuffer()); q.enableVertexAttribArray(0); q.enableVertexAttribArray(1); q.bindBuffer(q.ELEMENT_ARRAY_BUFFER, q.createBuffer()); q.uniform1i(q.getUniformLocation(f, "image"), 0); q.pixelStorei(q.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !0); a = q
                                    } return !0
                                } let a =
                                    null, c = 0, d = 0, e = null, g = null, m = 0, l = 0, n = !1; b(); this.Ob = function () { b(); return d }; this.yb = function (f) { a.deleteTexture && a.deleteTexture(f) }; this.wb = function (f) {
                                        if (!b()) return null; const r = a.createTexture(); if (!r) return null; a.bindTexture(a.TEXTURE_2D, r); a.texImage2D(a.TEXTURE_2D, 0, a.RGBA, a.RGBA, a.UNSIGNED_BYTE, f); a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_S, a.CLAMP_TO_EDGE); a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_T, a.CLAMP_TO_EDGE); a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MAG_FILTER, a.LINEAR); 2 == c ? (a.texParameteri(a.TEXTURE_2D,
                                            a.TEXTURE_MIN_FILTER, a.LINEAR_MIPMAP_LINEAR), a.generateMipmap(a.TEXTURE_2D)) : a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MIN_FILTER, a.LINEAR); return r
                                    }; const k = new da(8), t = new da(8), v = new da(10), x = new da(10); this.Cb = function (f, r, q, G, D) {
                                        if (b()) {
                                            var u = k.push(f), I = t.push(r); if (a.canvas) {
                                                if (a.canvas.width != u || a.canvas.height != I) a.canvas.width = u, a.canvas.height = I; a.viewport(0, I - r, f, r); a.disable(a.SCISSOR_TEST); a.clearColor(0, 0, 0, 0); a.clear(a.COLOR_BUFFER_BIT); a.enable(a.SCISSOR_TEST); q.sort((A, W) => W.lb - A.lb);
                                                u = v.push(G); m != u && (a.bufferData(a.ARRAY_BUFFER, 8 * u, a.DYNAMIC_DRAW), m = u); u = 0; for (var O of q) a.bufferSubData(a.ARRAY_BUFFER, u, O.Sa), u += 4 * O.Sa.length; console.assert(u == 4 * G); for (var X of q) a.bufferSubData(a.ARRAY_BUFFER, u, X.ob), u += 4 * X.ob.length; console.assert(u == 8 * G); u = x.push(D); l != u && (a.bufferData(a.ELEMENT_ARRAY_BUFFER, 2 * u, a.DYNAMIC_DRAW), l = u); O = 0; for (var ia of q) a.bufferSubData(a.ELEMENT_ARRAY_BUFFER, O, ia.indices), O += 2 * ia.indices.length; console.assert(O == 2 * D); ia = 0; X = !0; u = O = 0; for (const A of q) {
                                                    A.image.Na !=
                                                    ia && (a.bindTexture(a.TEXTURE_2D, A.image.Ma || null), ia = A.image.Na); A.Rb ? (a.scissor(A.Xa, I - A.Ya - A.fb, A.bc, A.fb), X = !0) : X && (a.scissor(0, I - r, f, r), X = !1); q = 2 / f; const W = -2 / r; a.uniform4f(e, A.xa[0] * q * A.Ga, A.xa[1] * W * A.Ha, A.xa[2] * q * A.Ga, A.xa[3] * W * A.Ha); a.uniform2f(g, A.xa[4] * q * A.Ga + q * (A.Xa - A.Pb * A.Ga) - 1, A.xa[5] * W * A.Ha + W * (A.Ya - A.Qb * A.Ha) + 1); a.vertexAttribPointer(0, 2, a.FLOAT, !1, 0, u); a.vertexAttribPointer(1, 2, a.FLOAT, !1, 0, u + 4 * G); a.drawElements(a.TRIANGLES, A.indices.length, a.UNSIGNED_SHORT, O); u += 4 * A.Sa.length; O += 2 *
                                                        A.indices.length
                                                } console.assert(u == 4 * G); console.assert(O == 2 * D)
                                            }
                                        }
                                    }; this.canvas = function () { return b() && a.canvas }
                            }, ha = h.onRuntimeInitialized;
                            h.onRuntimeInitialized = function () {
                                ...
                                let f = 1; var r = h.RenderImage.extend("CanvasRenderImage", { __construct: function ({ Aa: p, Fa: w } = {}) { this.__parent.__construct.call(this); this.Na = f; f = f + 1 & 2147483647 || 1; this.Aa = p; this.Fa = w }, __destruct: function () { this.Ma && (fa.yb(this.Ma), URL.revokeObjectURL(this.Va)); this.__parent.__destruct.call(this) }, decode: function (p) { var w = this; w.Fa && w.Fa(w); var B = new Image; w.Va = URL.createObjectURL(new Blob([p], { type: "image/png" })); B.src = w.Va; B.onload = function () { w.qb = B; w.Ma = fa.wb(B); w.size(B.width, B.height); w.Aa && w.Aa(w) } } }),
                                    ...
                                    G = g.extend("CanvasRenderPaint", {
                                        ...
                                        }, radialGradient: function (p, w, B, C) { this.za = { mb: p, nb: w, ab: B, bb: C, Qa: [], Mb: !0 } }, addStop: function (p, w) { this.za.Qa.push({ color: p, stop: w }) }, completeGradient: function () { }, draw: function (p, w, B) {
                                            let C = this.sb; var z = this.Wa, E = this.za; p.globalCompositeOperation = this.pb; if (null != E) {
                                                z = E.mb; var F = E.nb; const T = E.ab; var H = E.bb; const K = E.Qa; E.Mb ? (E = T - z, H -= F, z = p.createRadialGradient(z, F, 0, z, F, Math.sqrt(E * E + H * H))) : z = p.createLinearGradient(z, F, T, H); for (let Y = 0, N = K.length; Y < N; Y++)F = K[Y], z.addColorStop(F.stop,
                                                    a(F.color)); this.Wa = z; this.za = null
                                            } switch (C) { case v: p.strokeStyle = z; p.lineWidth = this.tb; p.lineCap = this.Ka; p.lineJoin = this.La; p.stroke(w); break; case t: p.fillStyle = z, p.fill(w, B) }
                                        }
                                    }); const D = new Set; let u = null, I = [], O = 0, X = 0; var ia = h.CanvasRenderer = m.extend("Renderer", {
                                        __construct: function (p) { this.__parent.__construct.call(this); this.oa = [1, 0, 0, 1, 0, 0]; this.ha = p.getContext("2d"); this.Ta = p; this.ja = [] }, save: function () { this.oa.push(...this.oa.slice(this.oa.length - 6)); this.ja.push(this.ha.save.bind(this.ha)) },
                                        restore: function () { const p = this.oa.length - 6; if (6 > p) throw "restore() called without matching save()."; this.oa.splice(p); this.ja.push(this.ha.restore.bind(this.ha)) }, transform: function (p, w, B, C, z, E) { const F = this.oa, H = F.length - 6; F.splice(H, 6, F[H] * p + F[H + 2] * w, F[H + 1] * p + F[H + 3] * w, F[H] * B + F[H + 2] * C, F[H + 1] * B + F[H + 3] * C, F[H] * z + F[H + 2] * E + F[H + 4], F[H + 1] * z + F[H + 3] * E + F[H + 5]); this.ja.push(this.ha.transform.bind(this.ha, p, w, B, C, z, E)) }, rotate: function (p) { const w = Math.sin(p); p = Math.cos(p); this.transform(p, w, -w, p, 0, 0) }, _drawPath: function (p,
                                            w) { this.ja.push(w.draw.bind(w, this.ha, p.pa, p.Ua === x ? "evenodd" : "nonzero")) }, _drawRiveImage: function (p, w, B) { var C = p.qb; if (C) { var z = this.ha, E = b(w); this.ja.push(function () { z.globalCompositeOperation = E; z.globalAlpha = B; z.drawImage(C, 0, 0); z.globalAlpha = 1 }) } }, _getMatrix: function (p) { const w = this.oa, B = w.length - 6; for (let C = 0; 6 > C; ++C)p[C] = w[B + C] }, _drawImageMesh: function (p, w, B, C, z, E, F, H, T, K) {
                                                var Y = this.ha.canvas.width, N = this.ha.canvas.height; const sb = T - F, tb = K - H; F = Math.max(F, 0); H = Math.max(H, 0); T = Math.min(T, Y);
                                                K = Math.min(K, N); const wa = T - F, xa = K - H; console.assert(wa <= Math.min(sb, Y)); console.assert(xa <= Math.min(tb, N)); if (!(0 >= wa || 0 >= xa)) {
                                                    T = wa < sb || xa < tb; Y = K = 1; var ja = Math.ceil(wa * K), ka = Math.ceil(xa * Y); N = fa.Ob(); ja > N && (K *= N / ja, ja = N); ka > N && (Y *= N / ka, ka = N); u || (u = new h.DynamicRectanizer(N), u.reset(512, 512)); N = u.addRect(ja, ka); 0 > N && (c(), D.add(this), N = u.addRect(ja, ka), console.assert(0 <= N)); var ub = N & 65535, vb = N >> 16; I.push({
                                                        xa: this.oa.slice(this.oa.length - 6), image: p, Xa: ub, Ya: vb, Pb: F, Qb: H, bc: ja, fb: ka, Ga: K, Ha: Y, Sa: new Float32Array(C),
                                                        ob: new Float32Array(z), indices: new Uint16Array(E), Rb: T, lb: p.Na << 1 | (T ? 1 : 0)
                                                    }); O += C.length; X += E.length; var pa = this.ha, lc = b(w); this.ja.push(function () { pa.save(); pa.resetTransform(); pa.globalCompositeOperation = lc; pa.globalAlpha = B; const wb = fa.canvas(); wb && pa.drawImage(wb, ub, vb, ja, ka, F, H, wa, xa); pa.restore() })
                                                }
                                            }, _clipPath: function (p) { this.ja.push(this.ha.clip.bind(this.ha, p.pa, p.Ua === x ? "evenodd" : "nonzero")) }, clear: function () { D.add(this); this.ja.push(this.ha.clearRect.bind(this.ha, 0, 0, this.Ta.width, this.Ta.height)) },
                                        flush: function () { }, translate: function (p, w) { this.transform(1, 0, 0, 1, p, w) }
                                    }); h.makeRenderer = function (p) {
                                        const w = new ia(p), B = w.ha; return new Proxy(w, {
                                            get(C, z) {
                                                if ("function" === typeof C[z]) return function (...E) { return C[z].apply(C, E) }; if ("function" === typeof B[z]) {
                                                    if (-1 < ea.indexOf(z)) throw Error("RiveException: Method call to '" + z + "()' is not allowed, as the renderer cannot immediately pass through the return                 values of any canvas 2d context methods."); return function (...E) {
                                                        w.ja.push(B[z].bind(B,
                                                            ...E))
                                                    }
                                                } return C[z]
                                            }, set(C, z, E) { if (z in B) return B[z] = E, !0 }
                                        })
                                    }; h.decodeImage = function (p, w) { (new r({ Aa: w })).decode(p) }; h.renderFactory = { makeRenderPaint: function () { return new G }, makeRenderPath: function () { return new q }, makeRenderImage: function () { let p = W; return new r({ Fa: () => { p.total++ }, Aa: () => { p.loaded++; if (p.loaded === p.total) { const w = p.ready; w && (w(), p.ready = null) } } }) } }; let A = h.load, W = null; h.load = function (p, w, B = !0) {
                                        const C = new h.FallbackFileAssetLoader; void 0 !== w && C.addLoader(w); B && (w = new h.CDNFileAssetLoader,
                                            C.addLoader(w)); return new Promise(function (z) { let E = null; W = { total: 0, loaded: 0, ready: function () { z(E) } }; E = A(p, C); 0 == W.total && z(E) })
                                    }; d = new ca; h.requestAnimationFrame = d.requestAnimationFrame.bind(d); h.cancelAnimationFrame = d.cancelAnimationFrame.bind(d); h.enableFPSCounter = d.Db.bind(d); h.disableFPSCounter = d.Ab; d.hb = c; h.cleanup = function () { u && u.delete() }
                            }; const la = h.onRuntimeInitialized;
                            h.onRuntimeInitialized = function () {
                            ...
                            function $b(b, a, c, d, e) {
                                var g = a.length; 2 > g && R("argTypes array size mismatch! Must at least get return value and 'this' types!"); var m = null !== a[1] && null !== c, l = !1; for (c = 1; c < a.length; ++c)if (null !== a[c] && void 0 === a[c].ka) { l = !0; break } var n = "void" !== a[0].name, k = g - 2, t = Array(k), v = [], x = []; return function () {
                                    arguments.length !== k && R(`function ${b} called with ${arguments.length} arguments, expected ${k} args!`); x.length = 0; v.length = m ? 2 : 1; v[0] = e; if (m) { var f = a[1].toWireType(x, this); v[1] = f } for (var r = 0; r < k; ++r)t[r] =
                                        a[r + 2].toWireType(x, arguments[r]), v.push(t[r]); r = d.apply(null, v); if (l) Eb(x); else for (var q = m ? 1 : 2; q < a.length; q++) { var G = 1 === q ? f : t[q - 2]; null !== a[q].ka && a[q].ka(G) } f = n ? a[0].fromWireType(r) : void 0; return f
                                }
                            } function ac(b, a) { for (var c = [], d = 0; d < b; d++)c.push(P[a + 4 * d >> 2]); return c }
                            ...
                            var Gc = (b, a, c, d) => {
                                function e(f, r, q) { for (f = "number" == typeof f ? f.toString() : f || ""; f.length < r;)f = q[0] + f; return f } function g(f, r) { return e(f, r, "0") } function m(f, r) { function q(D) { return 0 > D ? -1 : 0 < D ? 1 : 0 } var G; 0 === (G = q(f.getFullYear() - r.getFullYear())) && 0 === (G = q(f.getMonth() - r.getMonth())) && (G = q(f.getDate() - r.getDate())); return G } function l(f) {
                                    switch (f.getDay()) {
                                    ...
                                    var r = f.ta; for (f = new Date((new Date(f.ua + 1900, 0, 1)).getTime()); 0 < r;) { var q = f.getMonth(), G = (Cc(f.getFullYear()) ? Dc : Ec)[q]; if (r > G - f.getDate()) r -= G - f.getDate() + 1, f.setDate(1), 11 > q ? f.setMonth(q + 1) : (f.setMonth(0), f.setFullYear(f.getFullYear() + 1)); else { f.setDate(f.getDate() + r); break } } q = new Date(f.getFullYear() + 1, 0, 4); r = l(new Date(f.getFullYear(),
                                        0, 4)); q = l(q); return 0 >= m(r, f) ? 0 >= m(q, f) ? f.getFullYear() + 1 : f.getFullYear() : f.getFullYear() - 1
                                } var k = M[d + 40 >> 2]; d = { $b: M[d >> 2], Zb: M[d + 4 >> 2], Ia: M[d + 8 >> 2], Ra: M[d + 12 >> 2], Ja: M[d + 16 >> 2], ua: M[d + 20 >> 2], na: M[d + 24 >> 2], ta: M[d + 28 >> 2], dc: M[d + 32 >> 2], Yb: M[d + 36 >> 2], ac: k ? k ? jc(L, k) : "" : "" }; c = c ? jc(L, c) : ""; k = {
                                    "%c": "%a %b %d %H:%M:%S %Y", "%D": "%m/%d/%y", "%F": "%Y-%m-%d", "%h": "%b", "%r": "%I:%M:%S %p", "%R": "%H:%M", "%T": "%H:%M:%S", "%x": "%m/%d/%y", "%X": "%H:%M:%S", "%Ec": "%c", "%EC": "%C", "%Ex": "%m/%d/%y", "%EX": "%H:%M:%S", "%Ey": "%y",
                                    "%EY": "%Y", "%Od": "%d", "%Oe": "%e", "%OH": "%H", "%OI": "%I", "%Om": "%m", "%OM": "%M", "%OS": "%S", "%Ou": "%u", "%OU": "%U", "%OV": "%V", "%Ow": "%w", "%OW": "%W", "%Oy": "%y"
                                }; for (var t in k) c = c.replace(new RegExp(t, "g"), k[t]); var v = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), x = "January February March April May June July August September October November December".split(" "); k = {
                                    "%a": f => v[f.na].substring(0, 3), "%A": f => v[f.na], "%b": f => x[f.Ja].substring(0, 3), "%B": f => x[f.Ja], "%C": f => g((f.ua + 1900) /
                                        100 | 0, 2), "%d": f => g(f.Ra, 2), "%e": f => e(f.Ra, 2, " "), "%g": f => n(f).toString().substring(2), "%G": f => n(f), "%H": f => g(f.Ia, 2), "%I": f => { f = f.Ia; 0 == f ? f = 12 : 12 < f && (f -= 12); return g(f, 2) }, "%j": f => { for (var r = 0, q = 0; q <= f.Ja - 1; r += (Cc(f.ua + 1900) ? Dc : Ec)[q++]); return g(f.Ra + r, 3) }, "%m": f => g(f.Ja + 1, 2), "%M": f => g(f.Zb, 2), "%n": () => "\n", "%p": f => 0 <= f.Ia && 12 > f.Ia ? "AM" : "PM", "%S": f => g(f.$b, 2), "%t": () => "\t", "%u": f => f.na || 7, "%U": f => g(Math.floor((f.ta + 7 - f.na) / 7), 2), "%V": f => {
                                            var r = Math.floor((f.ta + 7 - (f.na + 6) % 7) / 7); 2 >= (f.na + 371 - f.ta -
                                                2) % 7 && r++; if (r) 53 == r && (q = (f.na + 371 - f.ta) % 7, 4 == q || 3 == q && Cc(f.ua) || (r = 1)); else { r = 52; var q = (f.na + 7 - f.ta - 1) % 7; (4 == q || 5 == q && Cc(f.ua % 400 - 1)) && r++ } return g(r, 2)
                                        }, "%w": f => f.na, "%W": f => g(Math.floor((f.ta + 7 - (f.na + 6) % 7) / 7), 2), "%y": f => (f.ua + 1900).toString().substring(2), "%Y": f => f.ua + 1900, "%z": f => { f = f.Yb; var r = 0 <= f; f = Math.abs(f) / 60; return (r ? "+" : "-") + String("0000" + (f / 60 * 100 + f % 60)).slice(-4) }, "%Z": f => f.ac, "%%": () => "%"
                                }; c = c.replace(/%%/g, "\x00\x00"); for (t in k) c.includes(t) && (c = c.replace(new RegExp(t, "g"), k[t](d)));
                                c = c.replace(/\0\0/g, "%"); t = Fc(c); if (t.length > a) return 0; Ba.set(t, b); return t.length - 1
                            ...
                            Vb.prototype.fromWireType = function (b) {
                                function a() { return this.Ea ? Bb(this.ca.ma, { ea: this.Sb, da: c, la: this, ia: b }) : Bb(this.ca.ma, { ea: this, da: b }) } var c = this.Hb(b); if (!c) return this.$a(b), null; var d = yb(this.ca, c); if (void 0 !== d) { if (0 === d.ba.count.value) return d.ba.da = c, d.ba.ia = b, d.clone(); d = d.clone(); this.$a(b); return d } d = this.ca.Gb(c); d = xb[d]; if (!d) return a.call(this); d = this.Da ? d.vb : d.pointerType; var e = rb(c, this.ca, d.ca); return null === e ? a.call(this) : this.Ea ? Bb(d.ca.ma, { ea: d, da: e, la: this, ia: b }) : Bb(d.ca.ma,
                                    { ea: d, da: e })
                            }; Yb = h.UnboundTypeError = bb("UnboundTypeError");
                            var Kc = {
                                N: function (b, a, c) {
                                    b = U(b); a = nb(a, "wrapper"); c = S(c); var d = [].slice, e = a.ca, g = e.ma, m = e.fa.ma, l = e.fa.constructor; b = Ya(b, function () { e.fa.ib.forEach(function (k) { if (this[k] === m[k]) throw new cb(`Pure virtual function ${k} must be implemented in JavaScript`); }.bind(this)); Object.defineProperty(this, "__parent", { value: g }); this.__construct.apply(this, d.call(arguments)) }); g.__construct = function () {
                                        this === g && R("Pass correct 'this' to __construct"); var k = l.implement.apply(void 0, [this].concat(d.call(arguments)));
                                        ob(k); var t = k.ba; k.notifyOnDestruction(); t.ya = !0; Object.defineProperties(this, { ba: { value: t } }); Cb(this); k = t.da; k = ib(e, k); hb.hasOwnProperty(k) ? R(`Tried to register registered instance: ${k}`) : hb[k] = this
                                    }; g.__destruct = function () { this === g && R("Pass correct 'this' to __destruct"); ob(this); var k = this.ba.da; k = ib(e, k); hb.hasOwnProperty(k) ? delete hb[k] : R(`Tried to unregister unregistered instance: ${k}`) }; b.prototype = Object.create(g); for (var n in c) b.prototype[n] = c[n]; return ab(b)
                                }, O: function (b) {
                                    var a = Db[b];
                                    delete Db[b]; var c = a.Pa, d = a.ra, e = a.cb, g = e.map(m => m.Kb).concat(e.map(m => m.Vb)); V([b], g, m => {
                                        var l = {}; e.forEach((n, k) => { var t = m[k], v = n.Ib, x = n.Jb, f = m[k + e.length], r = n.Ub, q = n.Wb; l[n.Eb] = { read: G => t.fromWireType(v(x, G)), write: (G, D) => { var u = []; r(q, G, f.toWireType(u, D)); Eb(u) } } }); return [{
                                            name: a.name, fromWireType: function (n) { var k = {}, t; for (t in l) k[t] = l[t].read(n); d(n); return k }, toWireType: function (n, k) {
                                                for (var t in l) if (!(t in k)) throw new TypeError(`Missing field: "${t}"`); var v = c(); for (t in l) l[t].write(v,
                                                    k[t]); null !== n && n.push(d, v); return v
                                            }, argPackAdvance: 8, readValueFromPointer: Fb, ka: d
                                        }]
                                    })
                                }, C: function () { }, K: function (b, a, c, d, e) { var g = Jb(c); a = U(a); Ib(b, { name: a, fromWireType: function (m) { return !!m }, toWireType: function (m, l) { return l ? d : e }, argPackAdvance: 8, readValueFromPointer: function (m) { if (1 === c) var l = Ba; else if (2 === c) l = Ca; else if (4 === c) l = M; else throw new TypeError("Unknown boolean type size: " + a); return this.fromWireType(l[m >> g]) }, ka: null }) }, f: function (b, a, c, d, e, g, m, l, n, k, t, v, x) {
                                    t = U(t); g = Z(e, g); l && (l =
                                        Z(m, l)); k && (k = Z(n, k)); x = Z(v, x); var f = Xa(t); Ob(f, function () { Zb(`Cannot construct ${t} due to unbound types`, [d]) }); V([b, a, c], d ? [d] : [], function (r) {
                                            r = r[0]; if (d) { var q = r.ca; var G = q.ma } else G = Mb.prototype; r = Ya(f, function () {
                                            ...
                                            }); var D = Object.create(G, { constructor: { value: r } }); r.prototype = D; var u = new Pb(t, r, D, x, q, g, l, k); u.fa && (void 0 === u.fa.Ca && (u.fa.Ca = []), u.fa.Ca.push(u)); q = new Vb(t, u, !0, !1); G = new Vb(t + "*", u, !1, !1); var I = new Vb(t + " const*", u, !1, !0); xb[b] = { pointerType: G, vb: I }; Wb(f, r); return [q, G, I]
                                        })
                                }, j: function (b, a, c, d, e, g, m) {
                                    var l = ac(c, d); a = U(a); g = Z(e, g); V([], [b], function (n) {
                                        function k() { Zb(`Cannot call ${t} due to unbound types`, l) } n = n[0]; var t = `${n.name}.${a}`; a.startsWith("@@") && (a = Symbol[a.substring(2)]);
                                        var v = n.ca.constructor; void 0 === v[a] ? (k.va = c - 1, v[a] = k) : (Nb(v, a, t), v[a].ga[c - 1] = k); V([], l, function (x) { x = $b(t, [x[0], null].concat(x.slice(1)), null, g, m); void 0 === v[a].ga ? (x.va = c - 1, v[a] = x) : v[a].ga[c - 1] = x; if (n.ca.Ca) for (const f of n.ca.Ca) f.constructor.hasOwnProperty(a) || (f.constructor[a] = x); return [] }); return []
                                    })
                                }, x: function (b, a, c, d, e, g, m, l) {
                                    a = U(a); g = Z(e, g); V([], [b], function (n) {
                                        n = n[0]; var k = `${n.name}.${a}`, t = { get() { Zb(`Cannot access ${k} due to unbound types`, [c]) }, enumerable: !0, configurable: !0 }; t.set =
                                            l ? () => { Zb(`Cannot access ${k} due to unbound types`, [c]) } : () => { R(`${k} is a read-only property`) }; Object.defineProperty(n.ca.constructor, a, t); V([], [c], function (v) { v = v[0]; var x = { get() { return v.fromWireType(g(d)) }, enumerable: !0 }; l && (l = Z(m, l), x.set = f => { var r = []; l(d, v.toWireType(r, f)); Eb(r) }); Object.defineProperty(n.ca.constructor, a, x); return [] }); return []
                                    })
                                }, s: function (b, a, c, d, e, g) {
                                    var m = ac(a, c); e = Z(d, e); V([], [b], function (l) {
                                        l = l[0]; var n = `constructor ${l.name}`; void 0 === l.ca.sa && (l.ca.sa = []); if (void 0 !==
                                            l.ca.sa[a - 1]) throw new $a(`Cannot register multiple constructors with identical number of parameters (${a - 1}) for class '${l.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`); l.ca.sa[a - 1] = () => { Zb(`Cannot construct ${l.name} due to unbound types`, m) }; V([], m, function (k) { k.splice(1, 0, null); l.ca.sa[a - 1] = $b(n, k, null, e, g); return [] }); return []
                                    })
                                }, a: function (b, a, c, d, e, g, m, l) {
                                    var n = ac(c, d); a = U(a); g = Z(e, g); V([], [b], function (k) {
                                        function t() {
                                            Zb(`Cannot call ${v} due to unbound types`,
                                                n)
                                        } k = k[0]; var v = `${k.name}.${a}`; a.startsWith("@@") && (a = Symbol[a.substring(2)]); l && k.ca.ib.push(a); var x = k.ca.ma, f = x[a]; void 0 === f || void 0 === f.ga && f.className !== k.name && f.va === c - 2 ? (t.va = c - 2, t.className = k.name, x[a] = t) : (Nb(x, a, v), x[a].ga[c - 2] = t); V([], n, function (r) { r = $b(v, r, k, g, m); void 0 === x[a].ga ? (r.va = c - 2, x[a] = r) : x[a].ga[c - 2] = r; return [] }); return []
                                    })
                                }, e: function (b, a, c, d, e, g, m, l, n, k) {
                                    a = U(a); e = Z(d, e); V([], [b], function (t) {
                                        t = t[0]; var v = `${t.name}.${a}`, x = {
                                            get() {
                                                Zb(`Cannot access ${v} due to unbound types`,
                                                    [c, m])
                                            }, enumerable: !0, configurable: !0
                                        }; x.set = n ? () => { Zb(`Cannot access ${v} due to unbound types`, [c, m]) } : () => { R(v + " is a read-only property") }; Object.defineProperty(t.ca.ma, a, x); V([], n ? [c, m] : [c], function (f) { var r = f[0], q = { get() { var D = bc(this, t, v + " getter"); return r.fromWireType(e(g, D)) }, enumerable: !0 }; if (n) { n = Z(l, n); var G = f[1]; q.set = function (D) { var u = bc(this, t, v + " setter"), I = []; n(k, u, G.toWireType(I, D)); Eb(I) } } Object.defineProperty(t.ca.ma, a, q); return [] }); return []
                                    })
                                }, J: function (b, a) {
                                    a = U(a); Ib(b, {
                                        name: a,
                                        fromWireType: function (c) { var d = S(c); cc(c); return d }, toWireType: function (c, d) { return ab(d) }, argPackAdvance: 8, readValueFromPointer: Fb, ka: null
                                    })
                                }, p: function (b, a, c, d) { function e() { } c = Jb(c); a = U(a); e.values = {}; Ib(b, { name: a, constructor: e, fromWireType: function (g) { return this.constructor.values[g] }, toWireType: function (g, m) { return m.value }, argPackAdvance: 8, readValueFromPointer: dc(a, c, d), ka: null }); Ob(a, e) }, d: function (b, a, c) {
                                    var d = nb(b, "enum"); a = U(a); b = d.constructor; d = Object.create(d.constructor.prototype, {
                                        value: { value: c },
                                        constructor: { value: Ya(`${d.name}_${a}`, function () { }) }
                                    }); b.values[c] = d; b[a] = d
                                }, y: function (b, a, c) { c = Jb(c); a = U(a); Ib(b, { name: a, fromWireType: function (d) { return d }, toWireType: function (d, e) { return e }, argPackAdvance: 8, readValueFromPointer: ec(a, c), ka: null }) }, m: function (b, a, c, d, e, g) { var m = ac(a, c); b = U(b); e = Z(d, e); Ob(b, function () { Zb(`Cannot call ${b} due to unbound types`, m) }, a - 1); V([], m, function (l) { Wb(b, $b(b, [l[0], null].concat(l.slice(1)), null, e, g), a - 1); return [] }) }, l: function (b, a, c, d, e) {
                                    a = U(a); -1 === e && (e = 4294967295);
                                    e = Jb(c); var g = l => l; if (0 === d) { var m = 32 - 8 * c; g = l => l << m >>> m } c = a.includes("unsigned") ? function (l, n) { return n >>> 0 } : function (l, n) { return n }; Ib(b, { name: a, fromWireType: g, toWireType: c, argPackAdvance: 8, readValueFromPointer: fc(a, e, 0 !== d), ka: null })
                                }, g: function (b, a, c) { function d(g) { g >>= 2; var m = P; return new e(m.buffer, m[g + 1], m[g]) } var e = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][a]; c = U(c); Ib(b, { name: c, fromWireType: d, argPackAdvance: 8, readValueFromPointer: d }, { Lb: !0 }) },
                                z: function (b, a) {
                                    a = U(a); var c = "std::string" === a; Ib(b, {
                                        name: a, fromWireType: function (d) { var e = P[d >> 2], g = d + 4; if (c) for (var m = g, l = 0; l <= e; ++l) { var n = g + l; if (l == e || 0 == L[n]) { m = m ? jc(L, m, n - m) : ""; if (void 0 === k) var k = m; else k += String.fromCharCode(0), k += m; m = n + 1 } } else { k = Array(e); for (l = 0; l < e; ++l)k[l] = String.fromCharCode(L[g + l]); k = k.join("") } mb(d); return k }, toWireType: function (d, e) {
                                            e instanceof ArrayBuffer && (e = new Uint8Array(e)); var g = "string" == typeof e; g || e instanceof Uint8Array || e instanceof Uint8ClampedArray || e instanceof
                                                Int8Array || R("Cannot pass non-string to std::string"); var m = c && g ? hc(e) : e.length; var l = Jc(4 + m + 1), n = l + 4; P[l >> 2] = m; if (c && g) gc(e, L, n, m + 1); else if (g) for (g = 0; g < m; ++g) { var k = e.charCodeAt(g); 255 < k && (mb(n), R("String has UTF-16 code units that do not fit in 8 bits")); L[n + g] = k } else for (g = 0; g < m; ++g)L[n + g] = e[g]; null !== d && d.push(mb, l); return l
                                        }, argPackAdvance: 8, readValueFromPointer: Fb, ka: function (d) { mb(d) }
                                    })
                                }, u: function (b, a, c) {
                                    c = U(c); if (2 === a) { var d = mc; var e = nc; var g = oc; var m = () => Da; var l = 1 } else 4 === a && (d = pc, e =
                                        qc, g = rc, m = () => P, l = 2); Ib(b, { name: c, fromWireType: function (n) { for (var k = P[n >> 2], t = m(), v, x = n + 4, f = 0; f <= k; ++f) { var r = n + 4 + f * a; if (f == k || 0 == t[r >> l]) x = d(x, r - x), void 0 === v ? v = x : (v += String.fromCharCode(0), v += x), x = r + a } mb(n); return v }, toWireType: function (n, k) { "string" != typeof k && R(`Cannot pass non-string to C++ string type ${c}`); var t = g(k), v = Jc(4 + t + a); P[v >> 2] = t >> l; e(k, v + 4, t + a); null !== n && n.push(mb, v); return v }, argPackAdvance: 8, readValueFromPointer: Fb, ka: function (n) { mb(n) } })
                                }, Q: function (b, a, c, d, e, g) {
                                    Db[b] = {
                                        name: U(a),
                                        Pa: Z(c, d), ra: Z(e, g), cb: []
                                    }
                                }, P: function (b, a, c, d, e, g, m, l, n, k) { Db[b].cb.push({ Eb: U(a), Kb: c, Ib: Z(d, e), Jb: g, Vb: m, Ub: Z(l, n), Wb: k }) }, L: function (b, a) { a = U(a); Ib(b, { Nb: !0, name: a, argPackAdvance: 0, fromWireType: function () { }, toWireType: function () { } }) }, v: function (b, a, c) { b = S(b); a = nb(a, "emval::as"); var d = [], e = ab(d); P[c >> 2] = e; return a.toWireType(d, b) }, w: function (b, a, c, d, e) { b = uc[b]; a = S(a); c = tc(c); var g = []; P[d >> 2] = ab(g); return b(a, c, g, e) }, i: function (b, a, c, d) { b = uc[b]; a = S(a); c = tc(c); b(a, c, null, d) }, c: cc, h: function (b, a) {
                                    var c =
                                ...
                                }, t: function (b) { b = tc(b); return ab(h[b]) }, M: function (b, a) { b = S(b); a = S(a); return ab(b[a]) }, n: function (b) { 4 < b && (Q.get(b).kb += 1) }, o: function (b) { return ab(tc(b)) },
